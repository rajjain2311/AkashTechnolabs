    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($numRows>0){
            ...
            if($pass == $cpass){
                ...
                if($result){
                    $showAlert = true;
                    header("Location:/Internship_project/day 4/main.php?signupsuccess=true");
                    exit();
                }
            }
            else{
        ...
        header("Location : /Internship_project/day 4/main.php?signupsuccess=false&error=$showError");
    }
